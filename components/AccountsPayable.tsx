    ...
    reader.onload = async (event) => {
      try {
        ...
        headersRaw.forEach((h, idx) => {
          ...
          else if (nh.includes('numero doc')) colIndices.numeroDocumento = idx;
